...
/* harmony import */ var _modules_init_calculate_area__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-calculate-area */ "./js/modules/init-calculate-area.js");
/* harmony import */ var _modules_init_gallery_slider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-gallery-slider */ "./js/modules/init-gallery-slider.js");
/* harmony import */ var _modules_init_price_range__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-price-range */ "./js/modules/init-price-range.js");
/* harmony import */ var _modules_init_validate_email__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-validate-email */ "./js/modules/init-validate-email.js");
/* harmony import */ var _modules_init_validate_phone__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/init-validate-phone */ "./js/modules/init-validate-phone.js");
/* harmony import */ var _modules_init_input_tags__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/init-input-tags */ "./js/modules/init-input-tags.js");
/* harmony import */ var _modules_init_custom_select__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/init-custom-select */ "./js/modules/init-custom-select.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_init_calculate_area__WEBPACK_IMPORTED_MODULE_2__["initCalculateArea"])();
  Object(_modules_init_price_range__WEBPACK_IMPORTED_MODULE_4__["initPriceRange"])(); // initSmoothScroll();
  // Modules
  // ---------------------------------
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_init_gallery_slider__WEBPACK_IMPORTED_MODULE_3__["initGallerySlider"])();
    Object(_modules_init_validate_email__WEBPACK_IMPORTED_MODULE_5__["initValidateEmail"])();
    Object(_modules_init_validate_phone__WEBPACK_IMPORTED_MODULE_6__["initValidatePhone"])();
    Object(_modules_init_input_tags__WEBPACK_IMPORTED_MODULE_7__["initInputTags"])();
    Object(_modules_init_custom_select__WEBPACK_IMPORTED_MODULE_8__["initCustomSelect"])();
  });
});
...
var initCalculateArea = function initCalculateArea() {
  ...
  var areaWrapper = document.querySelector('.input__wrapper--area');
...
var initGallerySlider = function initGallerySlider() {
  var sliderItems = document.querySelectorAll('.gallery__slide');
  var filterBtn = document.querySelectorAll('.btn__filter');
  ...
  var position = 0;
  var slidesToShow = 8;
  var slidesToScroll = 8; // let mobile = window.matchMedia('(max-width: 767px)');
  // let tablet = window.matchMedia('(max-width: 1023px)');

  var container = document.querySelector('.gallery__slider');
  var track = document.querySelector('.gallery__slider-track');
  var btnPrev = document.querySelector('.gallery__btn-prev');
  var btnNext = document.querySelector('.gallery__btn-next');
  var itemWidth = container.clientWidth / slidesToShow;
  var movePosition = slidesToScroll * itemWidth;
  var items = document.querySelectorAll('.gallery__slide');
  ...
  var slideBulletLeft = function slideBulletLeft() {
    for (var _i = 0; _i < pagination.length; _i++) {
      if (pagination[_i].classList.contains('active') && _i > 0) {
        pagination[_i].classList.remove('active');

        pagination[_i - 1].classList.add('active');
  ...
  var slideBulletRight = function slideBulletRight() {
    for (var _i2 = 0; _i2 < pagination.length; _i2++) {
      if (pagination[_i2].classList.contains('active') && _i2 < pagination.length - 1) {
        pagination[_i2].classList.remove('active');

        pagination[_i2 + 1].classList.add('active');
  ...
  input.addEventListener('keydown', function (e) {
    if (e.keyCode === 13) {
      ...
      if (input.value !== '') {
        ...
        listArr = inValue.split(','); // listArr.push(inValue.replace(/\s/g, ''));
      ...
      tagsList = document.querySelector('.tags'); // tagsList.style.marginTop = '16px';
...
var initPriceRange = function initPriceRange() {
  document.getElementById('custom-slider').addEventListener('input', function (event) {
    var value = event.target.value; // document.getElementById('current-value').value = value;
...
var initValidateEmail = function initValidateEmail() {
  var emailRegex = /^[^\s@]+@[^\s@]+$/; // const emailRegex = /^[-\w.]+@([\w\-\_]+\.)+[A-z]{2,11}$/i;
  // const EMAIL_REGEXP = /^(([^<>()[\].,;:\s@"]+(\.[^<>()[\].,;:\s@"]+)*)|(".+"))@(([^<>()[\].,;:\s@"]+\.)+[^<>()[\].,;:\s@"]{2,})$/iu;

  var cyrillicPattern = /^[\u0400-\u04FF]+$/;
  var emailInput = document.querySelector('input[type="email"]');
  var btnDelete = document.querySelector('.input__delete'); // console.log(btnDelete);
  ...
  function updateInput() {
    if (validateEmail(emailInput.value)) {
      ...
      btnDelete.style.visibility = 'hidden'; // inputError.classList.remove('show');
  ...
  btnDelete.addEventListener('click', function () {
    // updateInput();
    emailInput.style.borderColor = '#0066CC';
    btnDelete.style.visibility = 'hidden'; // validateEmail(emailInput.value === '');
    // console.log(emailInput.value);
    // resetInput();
  });

  if (emailInput) {
    emailInput.addEventListener('input', updateInput); // emailInput.style.borderColor = '#0066CC';
  }
};
