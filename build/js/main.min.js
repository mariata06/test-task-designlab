...
/* harmony import */ var _modules_init_calculate_area__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-calculate-area */ "./js/modules/init-calculate-area.js");
/* harmony import */ var _modules_init_gallery_slider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-gallery-slider */ "./js/modules/init-gallery-slider.js");
/* harmony import */ var _modules_init_price_range__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/init-price-range */ "./js/modules/init-price-range.js");
/* harmony import */ var _modules_init_validate_email__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/init-validate-email */ "./js/modules/init-validate-email.js");
/* harmony import */ var _modules_init_input_tags__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/init-input-tags */ "./js/modules/init-input-tags.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_init_calculate_area__WEBPACK_IMPORTED_MODULE_4__["initCalculateArea"])(); // initFilter();

  Object(_modules_init_price_range__WEBPACK_IMPORTED_MODULE_6__["initPriceRange"])(); // Modules
  // ---------------------------------
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_init_gallery_slider__WEBPACK_IMPORTED_MODULE_5__["initGallerySlider"])();
    Object(_modules_init_validate_email__WEBPACK_IMPORTED_MODULE_7__["initValidateEmail"])();
    Object(_modules_init_input_tags__WEBPACK_IMPORTED_MODULE_8__["initInputTags"])();
  });
}); // ---------------------------------
...
var initCalculateArea = function initCalculateArea() {
  ...
  var inputNumber = areaWrapper.querySelector('input'); // let submitBtn = document.getElementById('.form__button');
...
var initGallerySlider = function initGallerySlider() {
  ...
  var filterBtn = document.querySelectorAll('.btn__filter'); // let sliderPagination = document.createElement('ul');
  ...
  var _loop = function _loop(i) {
    filterBtn[i].addEventListener('click', function (e) {
      ...
      itemsCount = items.length; // track.style.width = '120px';
  ...
  var itemsCount = items.length; // function myFunction(tablet) {
  ...
  btnPrev.addEventListener('click', function () {
    var itemsLeft = Math.abs(position) / itemWidth; // position += movePosition;
...
var initPriceRange = function initPriceRange() {
  ...
  // };
  var parent = document.querySelector('.range-slider'); // let rangeVal = document.getElementById('range-value');

  var rangeVal = parent.querySelector('input[type="range"]');
  var rangeInp = document.getElementById('range-input');

  var updateVal = function updateVal(val) {
...
var initValidateEmail = function initValidateEmail() {
  ...
  var emailRegex = /^[-\w.]+@([\w\-\_]+\.)+[A-z]{2,11}$/i; // const EMAIL_REGEXP = /^(([^<>()[\].,;:\s@"]+(\.[^<>()[\].,;:\s@"]+)*)|(".+"))@(([^<>()[\].,;:\s@"]+\.)+[^<>()[\].,;:\s@"]{2,})$/iu;

  var cyrillicPattern = /^[\u0400-\u04FF]+$/;
  var emailInput = document.querySelector('input[type="email"]');
  var btnDelete = document.querySelector('input[type="email"] ~ svg'); // console.log(btnDelete);
